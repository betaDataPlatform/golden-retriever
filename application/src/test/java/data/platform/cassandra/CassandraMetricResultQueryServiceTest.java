...
@Slf4j
public class CassandraMetricResultQueryServiceTest {
    ...
    public void testQuery() throws JsonProcessingException {
        ...
        LocalDateTime beginLocalDateTime = LocalDateTime.parse("2021-04-30 20:00:00", df);
        LocalDateTime endLocalDateTime = LocalDateTime.parse("2021-04-30 20:59:59", df);
        ...
        queryMetricTags.put("host", ImmutableSet.of("30.0.0.2","30.0.0.3"));
    ...
    public void testQueryTwoQueryMetric() throws JsonProcessingException {
        ...
        queryMetricTags1.put("host", ImmutableSet.of("30.0.0.2"));
