...
public class MetricValueEventProcess {
    ...
    public void init() {
        ...
        bizProcessPipe(metricValueEventFlux)
                .subscribe(count -> saveCounter.increment());
    }

    private Flux<Long> bizProcessPipe(Flux<MetricValueEvent> metricValueEventFlux) {
        ...
        return metricValueEventFlux
                ...
                .flatMap(metricValueEvent -> metricValueCommandService.save(metricValueEvent.getMetricValue()));
    }
}
